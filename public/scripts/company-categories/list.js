...
jQuery(function () {
  const form$ = jQuery("form#companyCategoryModal");
  const create$ = jQuery("button.btn-company-category-create");
  const modal$ = bootstrap.Modal.getOrCreateInstance(form$[0], {});
  const table$ = jQuery("#companyCategoriesTable");
  let tableInstance$;
